				...
				newUser
					...
					.then((user) => {
						if (newUser.count == 1) {
							req.flash(
								'success_msg',
								`Payment Successful! You Booked ${newUser.count} Ticket To Travel For ${newUser.destination} on ${newUser.bdate}`
							);
						} else {
							req.flash(
								'success_msg',
								`Payment Successful! You Booked ${newUser.count} Tickets To Travel For ${newUser.destination} on ${newUser.bdate}`
							);
						}
